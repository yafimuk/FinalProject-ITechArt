...
namespace ORM.Web.Helpers.StructureMap
{
	/// <summary>
	...
	public class StructureMapDependencyScope : ServiceLocatorImplBase, IDependencyScope
	{
		...
		new public object GetService(Type serviceType)
		{
			...
			object service = serviceType.IsAbstract || serviceType.IsInterface
		...
		{
			IEnumerable<object> services = Container.GetAllInstances(serviceType).Cast<object>();
			return services;
		}
		...
		{
			IEnumerable<object> allInstances = Container.GetAllInstances(serviceType).Cast<object>();
			return allInstances;
		}
